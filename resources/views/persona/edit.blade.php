...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if("{{ old('idPais') }}" != "") {
            ...
            p.ObtenerRegion("{{ $persona->idPais }}", "{{ $persona->idRegion }}");
        }
        
        if("{{ old('idRegion') }}" != "") {
            p.ObtenerProvincia("{{ old('idRegion') }}", "{{ old('idProvincia') }}");
        } else {
            p.ObtenerProvincia("{{ $persona->idRegion }}", "{{ $persona->idProvincia }}");
        }
        
        if("{{ old('idProvincia') }}" != "") {
            p.ObtenerComuna("{{ old('idProvincia') }}", "{{ old('idComuna') }}");
        } else {
            p.ObtenerComuna("{{ $persona->idProvincia }}", "{{ $persona->idComuna }}");
        }
    })
</script>
@endsection
...
<div class="container">
    ...
    @if(Session::has('primera_vez'))
        <div class="alert alert-warning">{{ Session::get('primera_vez') }}</div>
        {!! Session::forget('primera_vez') !!}
    @endif
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('persona.update', $persona->idPersona) }}">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="rut" type="text" class="form-control @error('rut') is-invalid @enderror" name="rut" value="{{ (old('rut') == "" ? $persona->rut : old('rut')) }}" autocomplete="rut" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nombres" type="text" class="form-control @error('nombres') is-invalid @enderror" name="nombres" value="{{ (old('nombres') == "" ? $persona->nombres : old('nombres')) }}" required autocomplete="nombres" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="apellido1" type="text" class="form-control @error('apellido1') is-invalid @enderror" name="apellido1" value="{{ (old('apellido1') == "" ? $persona->apellido1 : old('apellido1')) }}" required autocomplete="apellido1" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="apellido2" type="text" class="form-control @error('apellido2') is-invalid @enderror" name="apellido2" value="{{ (old('apellido2') == "" ? $persona->apellido2 : old('apellido2')) }}" autocomplete="apellido2" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="direccion" type="text" class="form-control @error('direccion') is-invalid @enderror" name="direccion" value="{{ (old('direccion') == "" ? $persona->direccion : old('direccion')) }}" autocomplete="direccion">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="celular" type="text" class="form-control @error('celular') is-invalid @enderror" name="celular" value="{{ (old('celular') == "" ? $persona->celular : old('celular')) }}" autocomplete="celular" placeholder="56922222222" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="text" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{ (old('telefono') == "" ? $persona->telefono : old('telefono')) }}" autocomplete="telefono" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="idSexo" class="form-control">
                                    ...
                                    @foreach($sexo as $sex)
                                    <option value="{{ $sex->idSexo }}" {{ ($sex->idSexo == (old('idSexo') == "" ? $persona->idSexo : old('idSexo')) ? 'selected' : '') }}>{{ $sex->glosa }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="idPais" class="form-control">
                                    ...
                                    <option value="{{ $pais->idPais }}" {{ ($pais->idPais == (old('idPais') == "" ? $persona->idPais : old('idPais')) ? 'selected' : '') }}>{{ $pais->nombre }}</option>
                                    @endforeach
                                </select>
