...
class CreateProcedureObtenerMenuItemMenu extends Migration {
    public function up() {
        DB::unprepared('
            DROP PROCEDURE IF EXISTS pa_obtener_menu_item_menu;
            CREATE PROCEDURE pa_obtener_menu_item_menu (IN i_padre INT, IN i_idUsuario INT) BEGIN
                ...
                DECLARE menu_item_cursor CURSOR FOR
                    ...
                    Where mi.padre = i_padre And pu.idUsuario = i_idUsuario
                    /*Group By mi.idMenu_Item*/
					Order By mi.idMenu, mi.padre, mi.orden
                ;
                ...
                get_menu_item: LOOP
                    ...
                    INSERT INTO Menu_Usuario (idMenu_Item, menu_padre, padre, glosa, link, imagen, target, desplegable, habilitado, descripcion, orden, vigente, idMenu, idUsuario, idPerfil)
                    ...
                    CALL pa_obtener_menu_item_menu(v_idMenu_Item, i_idUsuario); 
